...
add('package version phase260', /phase260-dispute-safe-penalty|phase265-dashboard-portal-completion|phase26[8-9]-|phase270-full-package-verified-hardened|phase271-site-ux-insight-polish|phase272-premium-redesign|phase273-package-100/.test(pkg.version));
['test:phase260','validate:phase260','phase260:final'].forEach(script => add(`package script:${script}`, !!pkg.scripts?.[script]));
add('final review points to phase260', /phase26[05]:final|phase27[0123]:final/.test(pkg.scripts?.['final:review'] || ''));
