...
fs.writeFileSync(path.join(root, 'docs/current/PHASE305_OPERATIONAL_MATRIX.json'), JSON.stringify(matrix, null, 2));
console.log(JSON.stringify({ ok: true, report: 'docs/current/PHASE305_OPERATIONAL_MATRIX.json', legacyReport: 'docs/current/PHASE299_OPERATIONAL_MATRIX.json', summary: summarizeFinalDeliveryMatrix(matrix), liveEvidence: liveEvidence._verifyProdReport }, null, 2));
