...
const retired = ['phase307-professional-polish.css','phase309-portal-screenshot-repair.css','portal-phase283-dashboard.css','nv0n-runtime.css','nv0n-generated.css','veridion-clean-v311.css','v311-','v331-','v332-','v333-','nv0n-'];
...
const report = { ok: failures.length === 0, phase: 'phase334-responsive-contract', checkedFiles: publicFiles.length, requiredBreakpoints, failures };
fs.mkdirSync(path.join(root, 'docs/current'), { recursive: true });
fs.writeFileSync(path.join(root, 'docs/current/PHASE334_RESPONSIVE_CONTRACT.json'), JSON.stringify(report, null, 2));
if (failures.length) {
