...
add('scripts:terminal-gates-phase347', () => {
  assert.ok(['npm run phase347:final','npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final','npm run phase358:final', 'npm run phase350:final','npm run phase358:final'].includes(scripts['delivery:final']));
  assert.ok(['npm run phase347:final','npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final','npm run phase358:final', 'npm run phase350:final','npm run phase358:final'].includes(scripts['release:predeploy']));
});
...
add('readme:phase347-command', () => assert.match(read('README.md'), /npm run phase347:final|npm run phase348:final|npm run phase349:final|npm run phase350:final|npm run phase358:final/));
add('run-all-tests:phase347', () => assert.match(read('RUN_ALL_TESTS.sh'), /npm run phase347:final|npm run phase348:final|npm run phase349:final|npm run phase350:final|npm run phase358:final/));
