...
add('script:delivery-final-points-phase345', ['npm run phase345:final','npm run phase346:final','npm run phase347:final','npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final', 'npm run phase350:final'].includes(scripts['delivery:final']), 'npm run phase346:final', scripts['delivery:final']);
add('script:release-predeploy-points-phase345', ['npm run phase345:final','npm run phase346:final','npm run phase347:final','npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final', 'npm run phase350:final'].includes(scripts['release:predeploy']), 'npm run phase346:final', scripts['release:predeploy']);
