...
add('version:phase345', /phase345|phase346|phase347|phase348|phase349|phase350|phase350|phase350|phase350|phase350/.test(String(pkg.version || '')), pkg.version || '');
...
add('script:delivery-final-points-phase345', ['npm run phase345:final','npm run phase346:final','npm run phase347:final','npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final','npm run phase358:final', 'npm run phase350:final','npm run phase358:final'].includes(scripts['delivery:final']), 'npm run phase346:final', scripts['delivery:final']);
add('script:release-predeploy-points-phase345', ['npm run phase345:final','npm run phase346:final','npm run phase347:final','npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final','npm run phase358:final', 'npm run phase350:final','npm run phase358:final'].includes(scripts['release:predeploy']), 'npm run phase346:final', scripts['release:predeploy']);
...
add('run-all-tests:phase345', /npm run phase(345|346|347|348|349|350):final/.test(runAll));
