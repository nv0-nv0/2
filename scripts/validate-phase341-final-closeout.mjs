...
check('package:delivery-final-current', () => assert.ok(['npm run phase341:final', 'npm run phase342:final', 'npm run phase343:final', 'npm run phase345:final', 'npm run phase346:final', 'npm run phase347:final', 'npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final','npm run phase358:final'].includes(pkg.scripts['delivery:final'])));
check('package:release-predeploy-current', () => assert.ok(['npm run phase341:final', 'npm run phase342:final', 'npm run phase343:final', 'npm run phase345:final', 'npm run phase346:final', 'npm run phase347:final', 'npm run phase348:final', 'npm run phase349:final', 'npm run phase350:final','npm run phase358:final'].includes(pkg.scripts['release:predeploy'])));
