...
check('package:phase341-version', () => assert.match(pkg.version, /phase341-final-closeout|phase342-merged-best|phase343-final-perfect/));
check('package:delivery-final-current', () => assert.ok(['npm run phase341:final', 'npm run phase342:final', 'npm run phase343:final'].includes(pkg.scripts['delivery:final'])));
check('package:release-predeploy-current', () => assert.ok(['npm run phase341:final', 'npm run phase342:final', 'npm run phase343:final'].includes(pkg.scripts['release:predeploy'])));
...
check('validator:phase340-accepts-phase341', () => assert.match(phase340Validator, /phase341-final-closeout|phase342-merged-best|phase343-final-perfect/));
