...
for (const file of ['apps/public/home/index.html','apps/public/demo/index.html','apps/public/veridion-demo/index.html']) {
  requireText(file, '무료 진단 시작');
  requireText(file, '이메일 입력 없이 시작');
}
for (const file of ['apps/public/home/index.html','apps/public/demo/index.html','apps/public/veridion-demo/index.html','apps/public/plans/index.html','apps/public/board/index.html','apps/public/auth/index.html']) {
