...
await fs.writeFile(manifestPath, JSON.stringify({ version: 'restore-drill-v1', createdAt: new Date().toISOString(), source, snapshot, sha256: digest, size: dbBuffer.length }, null, 2));
...
const report = { ok: true, contract: 'non-destructive-restore-drill', source, snapshot, restoreTarget, manifestPath, sha256: digest, bytes: restored.length, nonDestructive: true };
