...
for (const rel of ['runtime/data/db.seed.json', 'runtime/data/db.json', 'runtime/data/sessions.json']) {
...
console.log(JSON.stringify({ ok: true, checked: 'runtime-clean-release' }, null, 2));
