...
check('version:phase350', () => assert.match(pkg.version, /phase350-global-cta-semantics-closeout|phase351-prompt-full-sweep-closeout|phase353-full-package-closeout|phase354-deployment-security-closeout|phase355-organization-closeout|phase356-conversion-dashboard-closeout|phase357-global-qa-accessibility-closeout|phase358-commercial-deploy-integrity-closeout/));
check('delivery-final:phase350', () => assert.ok(['npm run phase350:final','npm run phase351:final','npm run phase353:final','npm run phase354:final','npm run phase355:final','npm run phase356:final','npm run phase357:final','npm run phase358:final'].includes(pkg.scripts['delivery:final'])));
check('release-predeploy:phase350', () => assert.ok(['npm run phase350:final','npm run phase351:final','npm run phase353:final','npm run phase354:final','npm run phase355:final','npm run phase356:final','npm run phase357:final','npm run phase358:final'].includes(pkg.scripts['release:predeploy'])));
check('run-all-tests:phase350', () => assert.match(read('RUN_ALL_TESTS.sh'), /npm run phase350:final|npm run phase351:final|npm run phase353:final|npm run phase354:final|npm run phase355:final|npm run phase356:final|npm run phase357:final|npm run phase358:final/));
