...
add('package-version-phase347', () => assert.match(pkg.version, /phase347-unified-diagnosis-final|phase348-final-unified-engine-closeout|phase349-customer-journey-closeout|phase350-global-cta-semantics-closeout|phase351-prompt-full-sweep-closeout|phase353-full-package-closeout|phase354-deployment-security-closeout|phase355-organization-closeout|phase356-conversion-dashboard-closeout|phase357-global-qa-accessibility-closeout|phase358-commercial-deploy-integrity-closeout/));
add('description-current-final', () => assert.match(pkg.description || '', /phase347 unified diagnosis|phase348 final unified diagnosis engine|phase349 customer journey|phase350 global cta semantics|phase351 prompt full sweep|phase353 full package validation|phase354 deployment security|phase355 organization closeout|phase356 conversion dashboard|phase357 global qa and accessibility|phase358 commercial deploy integrity/i));
add('delivery-final-current', () => assert.ok(['npm run phase347:final','npm run phase348:final','npm run phase349:final|npm run phase350:final', 'npm run phase350:final','npm run phase351:final','npm run phase353:final','npm run phase354:final','npm run phase355:final','npm run phase356:final','npm run phase357:final','npm run phase358:final'].includes(scripts['delivery:final'])));
add('release-predeploy-current', () => assert.ok(['npm run phase347:final','npm run phase348:final','npm run phase349:final|npm run phase350:final', 'npm run phase350:final','npm run phase351:final','npm run phase353:final','npm run phase354:final','npm run phase355:final','npm run phase356:final','npm run phase357:final','npm run phase358:final'].includes(scripts['release:predeploy'])));
