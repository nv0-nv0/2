...
check('package:delivery-final-phase343', () => assert.match(pkg.scripts['delivery:final'], /npm run phase(343|345|346|347|348|349|350|358):final/));
check('package:release-predeploy-phase343', () => assert.match(pkg.scripts['release:predeploy'], /npm run phase(343|345|346|347|348|349|350|358):final/));
...
check('run-all-tests:uses-terminal-gate', () => assert.match(runAll, /npm run phase(343|345|346|347|348|349|350|358):final/));
check('readme:terminal-command-current', () => {
  assert.match(readme, /npm run phase(343|345|346|347|348|349|350|358):final/);
  assert.match(readme, /release:predeploy.*delivery:final.*phase(343|345|346|347|348|349|350|358):final/s);
});
