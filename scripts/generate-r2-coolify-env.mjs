...
const lines = [
  ...
  'NV0_MAIL_ORDER_REGISTRATION_NUMBER=REPLACE_REAL_MAIL_ORDER_REGISTRATION_NUMBER',
  'POSTGRES_DB=nv0',
  'POSTGRES_USER=nv0',
  ...
  'NV0_PORTONE_API_SECRET=REPLACE_REAL_PORTONE_API_SECRET',
  'NV0_PORTONE_STORE_ID=REPLACE_REAL_PORTONE_STORE_ID',
  'NV0_PORTONE_CHANNEL_KEY=REPLACE_REAL_PORTONE_CHANNEL_KEY',
  'NV0_PORTONE_REDIRECT_URL=https://nv0.kr/checkout',
  'NV0_PORTONE_PAY_METHOD=CARD',
  'NV0_PORTONE_CUSTOMER_ID_PREFIX=nv0',
  'NV0_PORTONE_WEBHOOK_SECRET=REPLACE_REAL_PORTONE_WEBHOOK_SECRET',
  ...
  'NV0_CTA_AUTOPUBLISH_INTERVAL_MS=1800000',
