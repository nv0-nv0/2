...
add('package version phase258', /phase25[89]-(structural-hardening|demo-penalty-dashboard)|phase260-dispute-safe-penalty|phase265-dashboard-portal-completion|phase26[8-9]-|phase270-full-package-verified-hardened|phase271-site-ux-insight-polish|phase272-premium-redesign|phase273-package-100|phase274-customer-copy-readability|phase278-customer-perfect|phase283-dashboard-design-applied/.test(pkg.version));
...
add('ci workflow references phase258 gate', ci.includes('npm run phase258:final') || ci.includes('npm run phase270:final') || ci.includes('npm run phase271:final') || ci.includes('npm run phase272:final') || ci.includes('npm run phase273:final') || ci.includes('npm run phase274:final'));
...
add('RUN_ALL_TESTS current final gate', (has('RUN_ALL_TESTS.sh','npm run phase258:final') || has('RUN_ALL_TESTS.sh','npm run phase265:final') || has('RUN_ALL_TESTS.sh','npm run phase270:final') || has('RUN_ALL_TESTS.sh','npm run phase271:final') || has('RUN_ALL_TESTS.sh','npm run phase272:final') || has('RUN_ALL_TESTS.sh','npm run phase273:final') || has('RUN_ALL_TESTS.sh','npm run phase274:final')) && !has('RUN_ALL_TESTS.sh','phase203'));
