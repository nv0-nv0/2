...
add('package version phase258', /phase25[89]-(structural-hardening|demo-penalty-dashboard)|phase260-dispute-safe-penalty|phase265-dashboard-portal-completion|phase26[8-9]-|phase270-full-package-verified-hardened|phase271-site-ux-insight-polish|phase272-premium-redesign|phase273-package-100/.test(pkg.version));
...
add('ci workflow references phase258 gate', ci.includes('npm run phase258:final') || ci.includes('npm run phase270:final') || ci.includes('npm run phase271:final') || ci.includes('npm run phase272:final') || ci.includes('npm run phase273:final'));
