...
for (const [name, html] of Object.entries({ home, demo, productDemo })) {
  ...
  add(`${name}:canonical-form-and-result`, () => {
    for (const token of ['id="unifiedDiagnosisForm"','id="targetUrl"','id="scanBtn"','id="demoState"','id="demoResult"']) assert.ok(html.includes(token), token);
  });
