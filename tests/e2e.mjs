...
assert.match(pkg.version, /phase25[89]-(structural-hardening|demo-penalty-dashboard)|phase260-dispute-safe-penalty|phase265-dashboard-portal-completion|phase26[8-9]-|phase270-full-package-verified-hardened|phase271-site-ux-insight-polish|phase272-premium-redesign|phase273-package-100|phase274-customer-copy-readability/);
