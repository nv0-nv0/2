...
assert.match(pkg.version, /phase311-clean-redteam/);
for (const script of ['test:e2e','phase311:final','validate:phase311','redteam:global']) assert.ok(pkg.scripts[script], `missing script ${script}`);
...
console.log('E2E passed: phase311 structural/commercial flow');
