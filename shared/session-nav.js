const MENU_SELECTOR = '.site-menu, .vr-nav, .vr-top-actions';
const LOGIN_SELECTOR = '.login-link, a[href="/auth"].vr-icon-link';
...
function buildLogoutButton(loginLink, customer, status) {
  ...
  button.type = 'button';
  button.className = `${LOGOUT_CLASS} login-link vr-icon-link`;
