export const SERVICE_QUALITY_VERSION = 'service-quality-lock-v1';
...
export function buildConversionUrgencyModel(scan = {}, options = {}) {
  ...
  return {
    version: SERVICE_QUALITY_VERSION,
...
export function buildOutputQualityLock({ scan = {}, order = {}, asset = {} } = {}) {
  ...
  return {
    version: SERVICE_QUALITY_VERSION,
    scope: 'paid_output_quality_lock',
    plan,
    ok,
...
export function attachServiceQuality(scan = {}, options = {}) {
