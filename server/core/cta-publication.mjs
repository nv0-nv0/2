...
핵심은 ${revenueLever}입니다. 글의 목적은 단순 홍보가 아닙니다. 사이트 담당자가 실제 화면을 보며 어디를 고쳐야 하는지 판단하도록 돕는 것입니다. 좋은 CTA 칼럼은 제품을 크게 외치기보다 고객이 멈추는 이유를 먼저 설명합니다. 그래서 본문은 문제, 영향, 해결 순서, 검증 기준, 다음 행동을 칼럼처럼 자연스럽게 이어야 합니다.`,
    `현장에서 자주 생기는 문제
...
export function ctaCombinationStats() {
  return {
    ...
    displayLabel: '글감, 업종, 고객 질문, 전문가형 칼럼 구조, 사례, 제목, FAQ, 연결된 공개 페이지, 수익화 CTA를 조합해 20분마다 4천~5천자 안팎의 전문 포스팅을 만듭니다.',
