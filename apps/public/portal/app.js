...
function updateStaticDashboard(session, account, summary) {
  ...
  if (workCard) workCard.innerHTML = `<div class="nv74-card-head"><h2>회원 전용 간단 기능</h2><a href="#saveSiteForm">사이트 등록 ›</a></div><div class="nv74-task-list"><div class="nv74-task"><i class="blue">⌕</i><div><b>내 사이트 저장</b><small>검사할 URL을 계정에 보관</small></div><progress value="100" max="100"></progress><span class="status ok">적용</span></div><div class="nv74-task"><i class="purple">↻</i><div><b>다시 검사하기</b><small>저장된 URL을 바로 재검사</small></div><progress value="100" max="100"></progress><span class="status ok">적용</span></div><div class="nv74-task"><i class="orange">▤</i><div><b>최근 검사 5개</b><small>지난 결과를 목록으로 확인</small></div><progress value="100" max="100"></progress><span class="status ok">적용</span></div></div>`;
}
